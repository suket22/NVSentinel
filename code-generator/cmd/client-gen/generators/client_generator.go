...
Origin: https://github.com/kubernetes/code-generator/blob/v0.34.1/cmd/client-gen/generators/client_generator.go
*/
...
func GetTargets(context *generator.Context, args *args.Args) []generator.Target {
	...
	for _, group := range args.Groups {
		for _, version := range group.Versions {
			...
			protoPackage := clientgentypes.NewProtobufPackage(args.ProtoBase, group.PackageName, version.Version.String())
			targetList = append(targetList,
				targetForGroup(
